<div class="col-sm-4">
        ...
        <input type="checkbox" value="true"  name="users_banned"  @if(kvjf($permissionid->permissions, 'users_banned')) checked @endif>
                                            ...
                                            <label>
                                                <!-- el value tiene que estar en true y con el nombre
                                                que viene del archivo wed ->name('users_form_permission').
                                                
                                                 kvjf -> se encuentra en el archivo function.php-->
        <input type="checkbox" value="true"  name="users_form_permission"  @if(kvjf($permissionid->permissions, 'users_form_permission')) checked @endif>
                                                <label for="users_form_permission">Puede dar permisos.</label>
                                            </label>
                                        </div>
                                    </div>
                                </div>
